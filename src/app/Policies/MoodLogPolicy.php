...
class MoodLogPolicy
{
    ...
    {
        return $user->can('view_any_mood::log');
    }
    ...
    {
        return $user->can('create_mood::log');
    }
    ...
    {
        return $user->can('update_mood::log');
    }
    ...
    {
        return $user->can('delete_mood::log');
    }
    ...
    {
        return $user->can('delete_any_mood::log');
    }
     ...
     */
    public function replicate(User $user, MoodLog $moodLog): bool
    {
